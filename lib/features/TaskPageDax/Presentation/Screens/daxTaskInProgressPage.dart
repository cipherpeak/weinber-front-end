...
import '../Provider/daxPercentageProviderInProgressPage.dart';

class DaxTaskInProgressScreen extends ConsumerWidget {
  const DaxTaskInProgressScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _checkItem(
              ref,
              index: 1,
              title: "Standard Tinting",
              isRequired: true,
            ),
            _checkItem(
              ref,
              index: 2,
              title: "Ceramic Coating - Layer 1",
              isRequired: true,
            ),
            _checkItem(
              ref,
              index: 3,
              title: "Ceramic Coating - Layer 2",
              isRequired: true,
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text("Standard Tinting - 50%", style: TextStyle(fontSize: 12)),
          const SizedBox(height: 4),
          const Text("Ceramic Coating - 2 Layer", style: TextStyle(fontSize: 12)),
